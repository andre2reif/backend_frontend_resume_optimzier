...
- The values (content) must be in the target language: English, German or Polish.
...
- Wartości (treści) mają być w języku docelowym: polskim, niemieckim lub angielskim.
